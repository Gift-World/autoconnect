      ...
      <section className="relative overflow-hidden rounded-3xl border border-primary/20 bg-gradient-to-br from-slate-950 via-slate-900 to-teal-950 p-6 text-white shadow-xl sm:p-9">
        ...
        <div className="relative">
          <Button
            ...
            variant="ghost"
            size="sm"
            className="-ml-3 mb-7 text-slate-300 hover:bg-white/10 hover:text-white"
          >
            <Link to="/garage">
          ...
          <div className="flex flex-col gap-6 sm:flex-row sm:items-end sm:justify-between">
            ...
            <div className="grid grid-cols-2 gap-2 text-xs sm:w-[330px]">
              <div className="rounded-2xl border border-white/10 bg-white/5 p-3">
                ...
                <p className="mt-2 font-semibold text-white">Evidence-led</p>
                <p className="mt-1 text-slate-400">Only completed checks count.</p>
              </div>
              <div className="rounded-2xl border border-white/10 bg-white/5 p-3">
                <Wrench className="h-4 w-4 text-teal-300" />
                <p className="mt-2 font-semibold text-white">Care-ready</p>
