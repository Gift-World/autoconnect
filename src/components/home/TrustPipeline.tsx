...
const VERIFICATION_STEPS = [
  {
    ...
    desc: "Digital chassis & VIN matching cross-referenced directly with NTSA, Interpol, and Japanese export deregistration records.",
  ...
  },
  {
    ...
    desc: "Verification of official logbook title, import entry declarations, and biometric ID checks for individual sellers and dealers.",
  ...
  },
  {
    ...
    desc: "Comprehensive mileage rollback detection with JEVIC, QISJ, and auction house service records.",
  ...
  },
  {
    ...
    desc: "Your purchase funds are deposited directly into a ring-fenced bank escrow account. Zero money reaches the seller upfront.",
    tag: "100% Funds Protected",
  },
  {
    step: "06",
    icon: Handshake,
