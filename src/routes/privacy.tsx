...
export const Route = createFileRoute("/privacy")({
  ...
  component: () => <PublicPolicyPage eyebrow="Privacy notice" title="How we handle your information" intro="This notice explains the information AutoConnect needs to operate a secure vehicle marketplace." sections={[
