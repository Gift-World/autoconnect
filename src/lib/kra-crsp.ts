...
export const POPULAR_CRSP_DATABASE: CrspVehicleModel[] = [
  {
    make: "Toyota",
    model: "Land Cruiser Prado TX/TZ",
    bodyType: "SUV",
    engineCc: 2700,
    fuelType: "petrol",
    baseNewCrspKes: 12500000,
  },
  {
    make: "Toyota",
    model: "Land Cruiser Prado Diesel",
    bodyType: "SUV",
    engineCc: 2800,
    fuelType: "diesel",
    baseNewCrspKes: 13800000,
  },
  {
    make: "Toyota",
    model: "Land Cruiser LC300 / V8",
    bodyType: "SUV",
    engineCc: 3500,
    fuelType: "petrol",
    baseNewCrspKes: 26000000,
  },
  {
    make: "Toyota",
    model: "RAV4 (G / X / Adventure)",
    bodyType: "SUV",
    engineCc: 2000,
    fuelType: "petrol",
    baseNewCrspKes: 7200000,
  },
  {
    make: "Toyota",
    model: "RAV4 Hybrid",
    ...
    engineCc: 2500,
    fuelType: "hybrid",
    baseNewCrspKes: 7800000,
  },
  {
    make: "Toyota",
    model: "Harrier (Premium / Elegance)",
    bodyType: "SUV",
    engineCc: 2000,
    fuelType: "petrol",
    baseNewCrspKes: 6800000,
  },
  {
    make: "Toyota",
    model: "Premio / Allion (1.5L - 2.0L)",
    bodyType: "Sedan",
    engineCc: 1800,
    fuelType: "petrol",
    baseNewCrspKes: 4200000,
  },
  {
    make: "Toyota",
    model: "Corolla Fielder / Axio",
    bodyType: "Station Wagon",
    engineCc: 1500,
    fuelType: "petrol",
    baseNewCrspKes: 3300000,
  },
  {
    make: "Toyota",
    ...
    engineCc: 1800,
    fuelType: "hybrid",
    baseNewCrspKes: 5600000,
  },
  {
    make: "Toyota",
    model: "Vitz / Yaris (1.0L - 1.3L)",
    bodyType: "Hatchback",
    engineCc: 1300,
    fuelType: "petrol",
    baseNewCrspKes: 2200000,
  },
  {
    make: "Toyota",
    ...
    engineCc: 2400,
    fuelType: "diesel",
    baseNewCrspKes: 7900000,
  },
  {
    make: "Toyota",
    model: "Hiace Van / Super GL",
    bodyType: "Van",
    engineCc: 2000,
    fuelType: "petrol",
    baseNewCrspKes: 4800000,
  },

  {
    make: "Subaru",
    model: "Forester (XT / XS / Sport)",
    bodyType: "SUV",
    engineCc: 2000,
    fuelType: "petrol",
    baseNewCrspKes: 5900000,
  },
  {
    make: "Subaru",
    model: "Outback (Limited / Touring)",
    bodyType: "Station Wagon",
    engineCc: 2500,
    fuelType: "petrol",
    baseNewCrspKes: 6400000,
  },
  {
    make: "Subaru",
    model: "XV / Crosstrek",
  ...
  },
  {
    ...
    engineCc: 1600,
    fuelType: "petrol",
    baseNewCrspKes: 3100000,
  },

  {
    make: "Mazda",
    model: "CX-5 (20S / 25S / XD)",
    bodyType: "SUV",
    engineCc: 2200,
    fuelType: "diesel",
    baseNewCrspKes: 5800000,
  },
  {
    make: "Mazda",
    model: "CX-3 / CX-30",
...

  {
    ...
    engineCc: 2000,
    fuelType: "petrol",
    baseNewCrspKes: 4900000,
  },
  {
    make: "Nissan",
    model: "Note / Note e-Power",
    bodyType: "Hatchback",
    engineCc: 1200,
    fuelType: "hybrid",
    baseNewCrspKes: 2300000,
  },
  {
    make: "Nissan",
  ...
  {
    make: "Mercedes-Benz",
    model: "C-Class (C180 / C200)",
    bodyType: "Sedan",
    engineCc: 1991,
    fuelType: "petrol",
    baseNewCrspKes: 9800000,
  },
  {
    make: "Mercedes-Benz",
    model: "E-Class (E220d / E250)",
    bodyType: "Sedan",
    engineCc: 1950,
    fuelType: "diesel",
    baseNewCrspKes: 14200000,
  },
  {
    make: "Mercedes-Benz",
    model: "GLE 350d / 450",
    ...
    engineCc: 2987,
    fuelType: "diesel",
    baseNewCrspKes: 21000000,
  },

  {
    make: "BMW",
    model: "X3 (xDrive 20d / 20i)",
    bodyType: "SUV",
    engineCc: 1995,
    fuelType: "diesel",
    baseNewCrspKes: 10400000,
  },
  {
    make: "BMW",
    model: "X5 (xDrive 30d / 40i)",
    bodyType: "SUV",
    engineCc: 2993,
    fuelType: "diesel",
    baseNewCrspKes: 18500000,
  },
  {
    make: "BMW",
    model: "3 Series (320i / 320d)",
    bodyType: "Sedan",
    engineCc: 1998,
    fuelType: "petrol",
    baseNewCrspKes: 8900000,
  },
  ...
  },
  {
    ...
    engineCc: 2993,
    fuelType: "diesel",
    baseNewCrspKes: 17500000,
  },

  {
    make: "Isuzu",
    model: "D-Max Double Cab 3.0L",
    bodyType: "Pickup",
    engineCc: 2999,
    fuelType: "diesel",
    baseNewCrspKes: 7400000,
  },
  {
    make: "Mitsubishi",
    model: "Outlander (PHEV / 24G)",
    bodyType: "SUV",
    engineCc: 2400,
    fuelType: "hybrid",
    baseNewCrspKes: 5100000,
  },
];
 ...
 */
export function getKraDepreciationRate(
 ...
 */
export function getKraExciseDutyRate(
  engineCc: number,
  fuelType: "petrol" | "diesel" | "hybrid" | "electric",
): number {
  if (fuelType === "electric" || fuelType === "hybrid") {
    return 0.1; // 10% green incentive
  }
  if (engineCc <= 1500) return 0.2; // 20%
  if (engineCc <= 2500) return 0.25; // 25%
  if (engineCc <= 3000) return 0.3; // 30%
...
export function calculateKraDuty({
  ...
  const totalKraTaxesKes = importDutyKes + exciseDutyKes + vatKes + idfKes + rdlKes;
  ...
  const estimatedUsdEquivalent = Math.round(totalDutyAndClearingKes / USD_TO_KES_ESTIMATE);
...
export function listCrspModelsForMake(make: string): CrspVehicleModel[] {
  return POPULAR_CRSP_DATABASE.filter((v) => v.make.toLowerCase() === make.toLowerCase());
}
